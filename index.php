          ...
          <div class="col-md-9 order-2">
            ...
            <div class="row">
              <div class="col-md-12 mb-5">
                <div class="float-md-left mb-4"><h2 class="text-black h5">Todos</h2></div>
                <div class="d-flex">
                  ...
                  <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                      ...
                      <a class="dropdown-item" href="#">Precio, más bajo a más alto</a>
                      <a class="dropdown-item" href="#">Precio, más alto a más bajo</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-3 order-1 mb-5 mb-md-0">
            <div class="border p-4 rounded mb-4">
              ...
              <?php
                ...
                $resultado1 = $conexion -> query("select * from categorias") or die($conexion -> error);
              ...
              ?>
                <li class="mb-1"><a href="#" class="d-flex"><span><?php echo $fila1['nombre']; ?></span> <span class="text-black ml-auto"></span></a></li>
